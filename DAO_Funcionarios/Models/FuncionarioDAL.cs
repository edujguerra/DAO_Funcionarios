...
namespace DAO_Funcionarios.Models
{
    ...
    {
        string connectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=BancoDadosGuerra;Integrated Security=True;";
        ...
        public Funcionario GetFuncionario(int? id)
        {
            ...
            using (SqlConnection con = new SqlConnection(connectionString))
            {
                string sqlQuery = "SELECT FuncionarioId,Nome,Cidade,Departamento,Sexo FROM Funcionarios WHERE FuncionarioId= " + id;
